    ...
    public static void init() {
        for(RenderPlayer render : Minecraft.getMinecraft().getRenderManager().getSkinMap().values()) { //Get Skin Types
            ...
            try {
                ...
                List<LayerRenderer<?>> layerRenderers = ObfuscationReflectionHelper.getPrivateValue(RendererLivingEntity.class, render, "field_177097_h");
                ...
                ObfuscationReflectionHelper.setPrivateValue(RendererLivingEntity.class, render, layerRenderers, "field_177097_h");
