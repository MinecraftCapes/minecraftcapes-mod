...
public class MenuScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        //Open MinecraftCapes
        this.addButton(new GuiButton(0,xOffset - 75, yOffset, 150, 20, "Open MinecraftCapes"));
        i++;
        ...
        //Custom Capes
        this.addButton(new GuiButton(1, xOffset - 155 + i % 2 * 160, yOffset + 24 * (i >> 1), 150, 20, getButtonString("Custom Capes", MinecraftCapesConfig.isCapeVisible())));
        i++;

        //Custom Ears
        this.addButton(new GuiButton(2, xOffset - 155 + i % 2 * 160, yOffset + 24 * (i >> 1), 150, 20, getButtonString("Custom Ears", MinecraftCapesConfig.isEarsVisible())));
        i++;
        ...
        //Reload Profile
        this.addButton(new GuiButton(3, xOffset - 75, yOffset + 24 * (i >> 1), 150, 20, "Reload Profile"));
        i++;

        //Done
        this.addButton(new GuiButton(4,xOffset - 100, yOffset + 24 * (i >> 1), 200, 20, I18n.format("gui.done")));
    }
    ...
    private void renderPlayer(int x, int y, int scale, EntityLivingBase livingEntity) {
        ...
        renderManager.renderEntity(livingEntity, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, false);
