...
public class MenuScreen extends Screen {
    ...
    public void init() {
        ...
        //Done
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, new TranslatableComponent("gui.done").getContents(), (button) -> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.font, this.title.getContents(), this.width / 2, 20, 16777215);
